...
<template>
  <MainContainer>
    <div class='flex flex-row w-full h-fit my-auto space-x-10'>
      <div class="basis-1/2 justify-center my-auto space-y-10 pr-10">
        <div class='space-y-3'>
          <h1 class='text-6xl font-bold'>Find useless stats!</h1>
